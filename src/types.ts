export interface Emergency {
  ...
  description: string;
  state: string; // e.g. "Distrito Capital", "Zulia", "Aragua", "Carabobo", "Lara", "Táchira"
  city: string;
  address: string;
  latitude: number;
  longitude: number;
...
export interface SocialPost {
  ...
  category: 'Alimentos' | 'Medicamentos' | 'Agua Potable' | 'Electricidad / Energía' | 'Transporte / Logística' | 'Refugio' | 'Atención Médica' | 'Seguridad' | 'Otro';
  title: string;
  description: string;
  state: string;
  city: string;
